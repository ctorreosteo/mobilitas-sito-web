...
export default function WhatsAppTooltipCofanettoNatale() {
        ...
        >
          ...
          >
            ...
            <div className="flex items-start gap-4 relative z-10">
              ...
              {/* Testo migliorato - coerente con l'offerta del cofanetto */}
              <div className="flex-1 min-w-0">
                <p className="text-base text-white leading-relaxed font-montserrat font-medium" style={{ marginTop: '0px', marginBottom: '0px' }}>
                  Hai domande sul Cofanetto Natalizio? Scrivici su WhatsApp per maggiori informazioni o per acquistarlo! 🎁
                </p>
              </div>
            </div>
