...
const HERO_VIDEO_CODICE = 'MENOPAUSA_VSL'
...
const PAIN_POINTS = [
  {
    ...
    body: 'Ondate improvvise di calore che partono dal petto e salgono al viso, spesso seguite da sudorazione.',
  },
  {
    icon: Moon,
    title: 'Sudorazioni notturne e risvegli',
    body: 'Ti svegli accaldata nel cuore della notte e poi fai fatica a riaddormentarti.',
  },
  {
    icon: Zap,
    title: 'Dolori articolari diffusi',
    body: 'Ginocchia, anche, spalle, mani. Un dolore che compare o peggiora proprio in questo periodo, senza un trauma che lo giustifichi.',
  },
  {
    icon: AlarmClock,
    title: 'Rigidità mattutina',
    body: 'Le articolazioni sono dure appena sveglia e ci vuole tempo prima di muoverti con scioltezza.',
  },
  {
    icon: CircleAlert,
    title: 'Cervicalgia e mal di testa più frequenti',
    body: 'Il collo si irrigidisce più facilmente e i mal di testa diventano più frequenti che in passato.',
  },
  {
    icon: Dumbbell,
    title: 'Perdita di massa muscolare e forza',
    body: 'Ti accorgi che fai più fatica in gesti che prima non ti pesavano affatto.',
  },
  {
    icon: BatteryLow,
    title: 'Stanchezza persistente',
    body: 'Una spossatezza di fondo che il riposo non risolve del tutto.',
  },
  {
    icon: Bed,
    title: 'Disturbi del sonno',
    body: 'Difficoltà ad addormentarti, sonno leggero, risvegli frequenti.',
  },
  {
    icon: Brain,
    title: 'Sbalzi d’umore, irritabilità, ansia',
    body: 'Reazioni emotive più intense e meno controllabili rispetto a prima.',
  },
  {
    icon: Droplets,
    title: 'Pesantezza e gonfiore a gambe e addome',
    body: 'Ritenzione di liquidi, sensazione di gambe pesanti, pancia gonfia più del solito.',
  },
]
...
function Menopausa() {
  const { video: heroVideo, loading: heroVideoLoading } = useVideoMenopausaVsl()
  ...
  useEffect(() => {
    ...
    const description =
      'Osteopata per menopausa a Torino (San Donato e Crocetta). Lavoriamo su rigidità dei tessuti, dolori articolari e sonno, in affiancamento al percorso ginecologico. Prima visita 49€.'
    ...
    ensureMetaByName(
      'keywords',
      [
        'osteopata menopausa torino',
        'menopausa osteopata',
        'dolori articolari menopausa',
        'rigidità menopausa osteopatia',
        'vampate e tensioni muscolari',
        'sonno menopausa osteopata',
        'cervicalgia menopausa torino',
        'tessuti menopausa trattamento',
        'osteopata ginecologo torino',
        'climaterio osteopata',
    ...
    ensureMetaByProperty('og:image:alt', 'Trattamento osteopatico per menopausa – Studio Mobilitas Torino')
    ...
    ensureMetaByName('twitter:title', 'Osteopata Menopausa Torino | Mobilitas')
    ensureMetaByName('twitter:description', description)
    ensureMetaByName('twitter:image', ogImage)
    ensureMetaByName('twitter:image:alt', 'Trattamento osteopatico per menopausa – Mobilitas Torino')
    ...
    const jsonLd = {
      ...
      '@graph': [
        ...
        },
        {
          ...
          name: 'Menopausa e cambiamenti muscoloscheletrici',
          alternateName: [
            'Menopausa',
            'Climaterio',
            'Perimenopausa',
            'Dolori articolari in menopausa',
            'Rigidità post-menopausa',
            'Vampate e tensioni muscolari',
          ],
          associatedAnatomy: {
            '@type': 'AnatomicalStructure',
            name: 'Muscoli, tendini, articolazioni e tessuti connettivi',
          },
        },
        {
          '@type': 'MedicalTherapy',
          '@id': `${pageUrl}#service`,
          name: 'Trattamento osteopatico per menopausa',
          description:
            'Approccio osteopatico su rigidità dei tessuti, dolori articolari, respiro e qualità del sonno, in affiancamento al percorso ginecologico e ormonale.',
          url: pageUrl,
          ...
          offers: {
            ...
            url: pageUrl,
            name: 'Prima visita osteopatica per menopausa',
          },
        },
        {
          ...businessShared,
    ...
    let scriptLd = document.querySelector('script[type="application/ld+json"][data-page="menopausa"]')
    if (!scriptLd) {
      scriptLd = document.createElement('script')
      scriptLd.setAttribute('type', 'application/ld+json')
      scriptLd.setAttribute('data-page', 'menopausa')
    ...
    return () => {
      ...
      const toRemove = document.querySelector('script[type="application/ld+json"][data-page="menopausa"]')
              ...
              <div className="relative overflow-hidden rounded-[calc(1rem-1px)] sm:rounded-[calc(1.35rem-1px)] aspect-[16/9] bg-[#002552]">
                {heroVideo ? (
                  <>
                    ...
                    <iframe
                      src={heroVideoSrc}
                      title={heroVideo.titolo || 'Video trattamento menopausa - Mobilitas Torino'}
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          ...
          >
            ...
            <p className="text-cream/60 text-base sm:text-lg leading-relaxed max-w-xl">
              ...
              <strong className="font-bold text-cream">scioltezza</strong>,{' '}
              <strong className="font-bold text-cream">notti</strong> e{' '}
              <strong className="font-bold text-cream">energia</strong> di fondo.
            </p>
          </motion.div>
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-14 lg:mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-16 items-center">
            {/* — Emblema animato: i tessuti che si irrigidiscono — */}
            <motion.figure
            ...
            >
              ...
              <div className="relative aspect-square">
                ...
                <svg viewBox="0 0 400 400" className="absolute inset-0 w-full h-full">
                  <defs>
                    <radialGradient id="menopausa-core" cx="50%" cy="50%" r="50%">
                  ...
                  {/* strati di tessuto che si irrigidiscono */}
                  <motion.g
                    animate={{ scale: [1, 0.97, 1] }}
                    transition={{ duration: 4.8, repeat: Infinity, ease: 'easeInOut' }}
                    style={{ transformOrigin: '200px 200px', transformBox: 'view-box' }}
                  >
                    <circle cx="200" cy="200" r="118" fill="none" stroke="#72fa93" strokeOpacity="0.14" strokeWidth="14" />
                    <circle cx="200" cy="200" r="88" fill="none" stroke="#72fa93" strokeOpacity="0.2" strokeWidth="14" />
                    <circle cx="200" cy="200" r="58" fill="none" stroke="#72fa93" strokeOpacity="0.28" strokeWidth="14" />
                    <circle cx="200" cy="200" r="118" fill="none" stroke="#72fa93" strokeOpacity="0.55" strokeWidth="1.25" />
                    <circle cx="200" cy="200" r="88" fill="none" stroke="#72fa93" strokeOpacity="0.7" strokeWidth="1.25" />
                    <circle cx="200" cy="200" r="58" fill="none" stroke="#72fa93" strokeOpacity="0.85" strokeWidth="1.5" />
                  </motion.g>

                  <circle cx="200" cy="200" r="36" fill="url(#menopausa-core)" />
                  <motion.circle
                    cx="200" cy="200" r="22"
              ...
              <figcaption className="px-4 py-3.5 sm:px-5 sm:py-4 text-center text-cream/55 text-sm leading-snug text-balance border-t border-cream/10">
                Il cambiamento è reale. La rigidità non è una condanna.
              </figcaption>
              </div>
              </div>
            </motion.figure>
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:block relative mx-auto max-w-4xl h-[48rem]">
            ...
            >
              <defs>
                <linearGradient id="visitWaveMenopausa" x1="0" y1="0" x2="0" y2="1">
                ...
                <filter id="visitGlowMenopausa" x="-50%" y="-8%" width="200%" height="116%">
          ...
          <div className="lg:hidden relative">
            ...
            >
              <defs>
                <linearGradient id="visitWaveMobileMenopausa" x1="0" y1="0" x2="0" y2="1">
              ...
              <path
                d="M40 10
                   ...
                   C 62 610, 18 670, 40 730
                   C 62 790, 18 850, 40 890"
                stroke="url(#visitWaveMobileMenopausa)"
                strokeWidth="2.25"
                strokeLinecap="round"
              />
              <path
