...
const HERO_VIDEO_CODICE = 'CICATRICI_SENO_VSL'
...
function useVideoCicatriciSenoVsl() {
...
const PAIN_POINTS = [
  {
    icon: Link2,
    title: 'Senso di tensione o “corda” sul torace',
    body: 'Una sensazione di stretto davanti, come se il petto fosse fasciato.',
  },
  {
    icon: Hand,
    title: 'Zona addormentata intorno alla cicatrice',
    body: 'Sotto il seno, sotto l’ascella o intorno al capezzolo, un’area con sensibilità ridotta o assente.',
  },
  {
    icon: Layers,
    title: 'Cicatrice dura, che non scorre',
    body: 'Provi a muoverla con le dita e resta attaccata, come incollata sotto.',
  },
  {
    icon: PersonStanding,
    title: 'Dolore dorsale tra le scapole',
    body: 'Un dolore posteriore, spesso comparso dopo l’intervento, senza un motivo apparente.',
  },
  {
    icon: MoveHorizontal,
    title: 'Spalle chiuse in avanti',
    body: 'La postura si è modificata: le spalle sono più anteposte e il torace più chiuso.',
  },
  {
    icon: ArrowUpFromLine,
    title: 'Limitazione nell’alzare il braccio',
    body: 'Portare il braccio in alto o indietro tira, soprattutto se la cicatrice è ascellare.',
  },
  {
    icon: Wind,
    title: 'Respiro corto o “che si ferma a metà”',
    body: 'Difficoltà a fare un respiro profondo, sensazione di ampiezza ridotta del torace.',
  },
  {
    icon: Moon,
    title: 'Fastidio dormendo a pancia in giù',
    body: 'La posizione prona diventa scomoda o dolorosa.',
  },
  {
    icon: Shirt,
    title: 'Fastidio con reggiseno, cinture o zaini',
    body: 'Qualsiasi cosa che prema su quella zona dà fastidio più del normale.',
  },
  {
    icon: CircleAlert,
    title: 'Tensione al collo',
    body: 'I muscoli che collegano torace e collo si irrigidiscono e tirano verso l’alto.',
  },
]
...
function CicatriciSeno() {
  const { video: heroVideo, loading: heroVideoLoading } = useVideoCicatriciSenoVsl()
  ...
  useEffect(() => {
    ...
    const description =
      'Osteopata per cicatrici del seno a Torino (San Donato e Crocetta). Lavoriamo su aderenze, torace, spalle e respiro dopo mastoplastica o chirurgia mammaria. Prima visita 49€.'
    ...
    ensureMetaByName(
      'keywords',
      [
        'osteopata cicatrici seno torino',
        'cicatrice seno osteopata',
        'aderenze dopo mastoplastica',
        'trattamento cicatrice seno',
        'torace teso dopo protesi',
        'post chirurgia mammaria osteopata',
        'cicatrice ascellare osteopatia',
        'spalle chiuse dopo seno rifatto',
        'massaggio cicatrice seno',
        'respiro dopo mastoplastica',
    ...
    ensureMetaByProperty('og:image:alt', 'Trattamento osteopatico per cicatrici del seno – Studio Mobilitas Torino')
    ...
    ensureMetaByName('twitter:title', 'Osteopata Cicatrici Seno Torino | Mobilitas')
    ensureMetaByName('twitter:description', description)
    ensureMetaByName('twitter:image', ogImage)
    ensureMetaByName('twitter:image:alt', 'Trattamento osteopatico per cicatrici del seno – Mobilitas Torino')
    ...
    const jsonLd = {
      ...
      '@graph': [
        ...
        },
        {
          ...
          name: 'Cicatrici del seno e aderenze toraciche',
          alternateName: [
            'Cicatrice seno',
            'Aderenze post-mastoplastica',
            'Cicatrice dopo seno rifatto',
            'Tensione toracica post-chirurgica',
            'Cicatrice ascellare',
            'Disfunzione cicatriziale mammaria',
          ],
          associatedAnatomy: {
            '@type': 'AnatomicalStructure',
            name: 'Torace, cicatrice mammaria, spalle e collo',
          },
        },
        {
          '@type': 'MedicalTherapy',
          '@id': `${pageUrl}#service`,
          name: 'Trattamento osteopatico per cicatrici del seno',
          description:
            'Approccio osteopatico integrato su cicatrici mammarie, aderenze, torace, spalle e respiro, nel rispetto della protesi e in affiancamento al chirurgo.',
          url: pageUrl,
          ...
          offers: {
            ...
            url: pageUrl,
            name: 'Prima visita osteopatica per cicatrici del seno',
          },
        },
        {
          ...businessShared,
    ...
    let scriptLd = document.querySelector('script[type="application/ld+json"][data-page="cicatrici-seno"]')
    if (!scriptLd) {
      scriptLd = document.createElement('script')
      scriptLd.setAttribute('type', 'application/ld+json')
      scriptLd.setAttribute('data-page', 'cicatrici-seno')
    ...
    return () => {
      ...
      const toRemove = document.querySelector('script[type="application/ld+json"][data-page="cicatrici-seno"]')
              ...
              <div className="relative overflow-hidden rounded-[calc(1rem-1px)] sm:rounded-[calc(1.35rem-1px)] aspect-[16/9] bg-[#002552]">
                {heroVideo ? (
                  <>
                    ...
                    <iframe
                      src={heroVideoSrc}
                      title={heroVideo.titolo || 'Video trattamento cicatrici seno - Mobilitas Torino'}
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-black leading-tight max-w-2xl mb-4 sm:mb-5">
              ...
              <br />
              <span className="text-green">Ti limita nel torace che non si apre più.</span>
            </h2>
            <p className="text-cream/60 text-base sm:text-lg leading-relaxed max-w-xl">
              ...
              <strong className="font-bold text-cream">respiro</strong>,{' '}
              <strong className="font-bold text-cream">movimento</strong> e{' '}
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-14 lg:mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-16 items-center">
            {/* — Emblema animato: il torace che si irrigidisce — */}
            <motion.figure
            ...
            >
              ...
              <div className="relative aspect-square">
                ...
                <svg viewBox="0 0 400 400" className="absolute inset-0 w-full h-full">
                  <defs>
                    <radialGradient id="cicatrici-seno-core" cx="50%" cy="50%" r="50%">
                  ...
                  {/* gabbia toracica stilizzata */}
                  <motion.g
                    animate={{ scaleX: [1, 1.04, 1] }}
                    transition={{ duration: 4.5, repeat: Infinity, ease: 'easeInOut' }}
                    style={{ transformOrigin: '200px 200px', transformBox: 'view-box' }}
                  >
                    <ellipse cx="200" cy="200" rx="108" ry="78" fill="none" stroke="#72fa93" strokeOpacity="0.22" strokeWidth="16" />
                    <ellipse cx="200" cy="200" rx="108" ry="78" fill="none" stroke="#72fa93" strokeOpacity="0.85" strokeWidth="1.5" />
                    <path d="M110 170 Q200 145 290 170" fill="none" stroke="#72fa93" strokeOpacity="0.45" strokeWidth="1.5" />
                    <path d="M105 200 Q200 175 295 200" fill="none" stroke="#72fa93" strokeOpacity="0.45" strokeWidth="1.5" />
                    <path d="M110 230 Q200 205 290 230" fill="none" stroke="#72fa93" strokeOpacity="0.45" strokeWidth="1.5" />
                  </motion.g>

                  {/* linea cicatrice */}
                  <motion.line
                    x1="155" y1="248" x2="245" y2="248"
                    stroke="#72fa93"
                    strokeWidth="3"
                    strokeLinecap="round"
                  ...
                  <circle cx="200" cy="200" r="38" fill="url(#cicatrici-seno-core)" />
                  <motion.circle
                    cx="200" cy="200" r="24"
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:block relative mx-auto max-w-4xl h-[48rem]">
            ...
            >
              <defs>
                <linearGradient id="visitWaveCicatriciSeno" x1="0" y1="0" x2="0" y2="1">
                ...
                <filter id="visitGlowCicatriciSeno" x="-50%" y="-8%" width="200%" height="116%">
              ...
              <path
                ...
                strokeOpacity="0.14"
                strokeLinecap="round"
                filter="url(#visitGlowCicatriciSeno)"
              />
              <path
                d="M260 48
                   C 260 95, 540 115, 540 160
                   ...
                   C 260 543, 540 563, 540 608
                   C 540 653, 260 673, 260 720"
                stroke="url(#visitWaveCicatriciSeno)"
                strokeWidth="2.5"
                strokeLinecap="round"
              />
              <path
          ...
          <div className="lg:hidden relative">
            ...
            >
              <defs>
                <linearGradient id="visitWaveMobileCicatriciSeno" x1="0" y1="0" x2="0" y2="1">
              ...
              <path
                d="M40 10
                   ...
                   C 62 610, 18 670, 40 730
                   C 62 790, 18 850, 40 890"
                stroke="url(#visitWaveMobileCicatriciSeno)"
                strokeWidth="2.25"
                strokeLinecap="round"
              />
              <path
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            e iniziamo a costruire un percorso concreto sullo scorrimento dei tessuti — oltre
            all’estetica.
          </motion.p>
