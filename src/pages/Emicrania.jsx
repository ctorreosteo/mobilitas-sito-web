...
const HERO_VIDEO_CODICE = 'EMICRANIA_VSL'
...
const HERO_BENEFITS = [
  <>
    Riprenditi i <strong className="font-bold">giorni</strong> che oggi cancelli dal calendario
  </>,
  <>
    Poter <strong className="font-bold">programmare</strong> qualcosa senza tenere una via di fuga
  </>,
  <>
    Non chiuderti più al <strong className="font-bold">buio</strong> mentre i tuoi figli giocano di là
  </>,
]
...
const PAIN_POINTS = [
  {
    icon: Activity,
    title: 'Dolore pulsante, spesso da un lato',
    body: 'Un dolore che batte al ritmo del battito, in genere su metà testa, tempia o zona oculare.',
  },
  {
    icon: Move,
    title: 'Peggiora con il movimento',
    body: 'Salire le scale, chinarsi o anche solo camminare intensifica il dolore.',
  },
  {
    icon: Droplets,
    title: 'Nausea e a volte vomito',
    body: 'Lo stomaco si chiude e nei casi peggiori si arriva a vomitare.',
  },
  {
    icon: Sun,
    title: 'Fastidio intenso a luce e rumore',
    body: 'Fotofobia e fonofobia che ti costringono a cercare buio e silenzio.',
  },
  {
    icon: Sparkles,
    title: 'Aura visiva prima dell’attacco',
    body: 'In una parte dei casi: luci, zig-zag, macchie o campo visivo ridotto nei minuti precedenti.',
  },
  {
    icon: Clock,
    title: 'Durata da qualche ora a giorni',
    body: 'Un attacco non trattato può durare da 4 a 72 ore.',
  },
  {
    icon: AlarmClock,
    title: 'Fase premonitoria',
    body: 'Sbadigli, irritabilità, voglia di dolci, stanchezza o rigidità al collo nelle ore precedenti.',
  },
  {
    icon: BatteryLow,
    title: 'Stanchezza profonda dopo l’attacco',
    body: 'La cosiddetta fase post-attacco: svuotamento, testa annebbiata e spossatezza per un giorno intero.',
  },
  {
    icon: Zap,
    title: 'Scatenanti riconoscibili',
    body: 'Ciclo mestruale, sonno irregolare, digiuno, alcol, cambi di tempo, stress o rilascio dopo lo stress.',
  },
  {
    icon: PersonStanding,
    title: 'Tensione a collo e spalle associata',
    body: 'Rigidità cervicale e contrattura del trapezio spesso presenti prima o durante l’attacco.',
  },
]
...
const MECHANISM_STEPS = [
  {
    k: '01',
    t: 'Il terreno è neurologico',
    b: 'L’emicrania è un cervello più sensibile del normale agli stimoli: questo è il terreno, e non si cancella.',
  },
  {
    k: '02',
    t: 'La legna sul fuoco',
    b: 'Gli attacchi partono più facilmente quando il sistema è già sotto pressione: collo rigido, mandibola serrata, sonno rotto, respiro corto.',
  },
  {
    k: '03',
    t: 'Alzare la soglia',
    b: 'Su quella legna si può lavorare con le mani, per alzare la soglia oltre la quale l’attacco parte.',
  },
]
...
const BENEFITS = [
  ...
  },
  {
    ...
    alt: 'Lavoro osteopatico su collo e sistema di allerta',
    title: 'Buio e silenzio',
  ...
  },
  {
    ...
    alt: 'Approccio osteopatico su trigger fisici dell’emicrania',
    title: 'Diario alimentare ed eliminazione di cibi',
  ...
  },
  {
    ...
    body: 'Propranololo, topiramato, amitriptilina e flunarizina riducono la frequenza in una parte dei casi. Regolarizzare sonno e ritmi aiuta, ma con tensione cronica gli attacchi arrivano lo stesso. Integratori, fisioterapia cervicale e nuove terapie iniettive toccano pezzi del quadro — raramente la catena intera.',
  },
]

const AFTER_IMAGES_BENEFITS = [
  <>
    Far guardare finalmente il tuo <strong className="font-bold">collo</strong>, oltre agli esami del
    cervello
  </>,
  <>
    Ridurre il bisogno di <strong className="font-bold">farmaci</strong> sempre più forti
  </>,
  <>
    Lavorare sui tuoi <strong className="font-bold">scatenanti reali</strong>: sonno, tensione,
    mandibola, postura
  </>,
  <>
    Affiancare il tuo <strong className="font-bold">neurologo</strong>, non sostituirlo
  </>,
]
...
const VISIT_STEPS = [
  ...
  },
  {
    ...
    body: 'Colloquio e valutazione iniziale sui tuoi attacchi, i tuoi segnali d’allarme e i tuoi fattori scatenanti.',
  },
  {
    title: 'Trattamento specifico',
    body: 'Se indicato, iniziamo scioglimento di collo e nuca, lavoro su mandibola e masticazione, sblocco dolce delle prime vertebre e lavoro su respiro e sistema di allerta.',
  },
  {
    title: 'Indicazioni pratiche personalizzate',
    body: 'Ti diamo un piano tra un attacco e l’altro: il lavoro si fa nei periodi liberi, non durante la crisi.',
  },
]
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    question: (
      <>
        L’<strong>emicrania</strong> è neurologica: cosa c’entrano le <em>mani</em>?
      </>
    ),
    answer: (
      <>
  ...
  },
  {
    ...
    answer: (
      <>
        In presenza di mal di testa improvviso e violentissimo mai provato prima (pronto soccorso
        subito), aura che dura più di un’ora o disturbi di vista, parola o forza che non passano,
        emicrania che cambia completamente carattere o frequenza, prima emicrania comparsa dopo i 50
        anni, oppure mal di testa con febbre alta e collo rigido, la priorità è la valutazione medica
...
function Emicrania() {
  const { video: heroVideo, loading: heroVideoLoading } = useVideoEmicraniaVsl()
  ...
  useEffect(() => {
    ...
    const pageUrl = `${origin}/emicrania`
    const ogImage = `${origin}/bruxismo/bruxismo1.JPG`

    const title =
      'Osteopata Emicrania Torino | Collo, Mandibola e Cefalea | Mobilitas'
    ...
    const description =
      'Osteopata per emicrania a Torino (San Donato e Crocetta). Lavoriamo su collo, mandibola e tensioni fisiche, in affiancamento al neurologo. Prima visita 49€.'
    ...
    ensureMetaByName(
      'keywords',
      [
        'osteopata emicrania torino',
        'emicrania torino',
        'osteopatia emicrania',
        'trattamento emicrania osteopata',
        'cefalea osteopata torino',
        'mal di testa cronico torino',
        'aura emicrania trattamento',
        'cervicalgia emicrania osteopata',
        'mandibola emicrania osteopata',
        'profilassi emicrania osteopata',
    ...
    ensureMetaByProperty('og:image:alt', 'Trattamento osteopatico per emicrania – Studio Mobilitas Torino')
    ...
    ensureMetaByName('twitter:title', 'Osteopata Emicrania Torino | Mobilitas')
    ensureMetaByName('twitter:description', description)
    ensureMetaByName('twitter:image', ogImage)
    ensureMetaByName('twitter:image:alt', 'Trattamento osteopatico per emicrania – Mobilitas Torino')
      ...
      '@graph': [
        ...
        },
        {
          ...
          associatedAnatomy: {
            ...
            name: 'Sistema nervoso centrale, collo e mandibola',
          },
        },
        {
          '@type': 'MedicalTherapy',
          '@id': `${pageUrl}#service`,
          name: 'Trattamento osteopatico per emicrania',
          description:
            'Approccio osteopatico integrato su collo, mandibola, respirazione e tensioni fisiche, in affiancamento al percorso neurologico.',
          url: pageUrl,
          ...
          offers: {
            ...
            url: pageUrl,
            name: 'Prima visita osteopatica per emicrania',
          },
        },
        {
          ...businessShared,
    ...
    let scriptLd = document.querySelector('script[type="application/ld+json"][data-page="emicrania"]')
    if (!scriptLd) {
      scriptLd = document.createElement('script')
      scriptLd.setAttribute('type', 'application/ld+json')
      scriptLd.setAttribute('data-page', 'emicrania')
    ...
    return () => {
      ...
      const toRemove = document.querySelector('script[type="application/ld+json"][data-page="emicrania"]')
      ...
      <section className="relative z-[2] pt-14 pb-16 sm:pt-20 sm:pb-24 lg:pt-28 lg:pb-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 text-left sm:text-center">
          ...
          >
            ...
            <strong className="font-bold text-cream">tensioni fisiche</strong> per ridurre l’impatto
            dell’emicrania su giornate, programmi e vita familiare.
          </motion.p>
              ...
              <div className="relative overflow-hidden rounded-[calc(1rem-1px)] sm:rounded-[calc(1.35rem-1px)] aspect-[16/9] bg-[#002552]">
                {heroVideo ? (
                  <>
                    ...
                    <iframe
                      src={heroVideoSrc}
                      title={heroVideo.titolo || 'Video trattamento emicrania - Mobilitas Torino'}
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-black leading-tight max-w-2xl mb-4 sm:mb-5">
              ...
              <br />
              <span className="text-green">Ti cancella giornate intere.</span>
            </h2>
            <p className="text-cream/60 text-base sm:text-lg leading-relaxed max-w-xl">
              ...
              <strong className="font-bold text-cream">programmi</strong> e{' '}
              <strong className="font-bold text-cream">presenza</strong> con chi ami.
            </p>
          </motion.div>
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-14 lg:mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-16 items-center">
            {/* — Emblema animato: collo, mandibola e cervello — */}
            <motion.figure
            ...
            >
              ...
              <div className="relative aspect-square">
                ...
                <svg viewBox="0 0 400 400" className="absolute inset-0 w-full h-full">
                  <defs>
                    <radialGradient id="emicrania-core" cx="50%" cy="50%" r="50%">
                  ...
                  <motion.circle
                    ...
                    animate={{ scale: [1, 0.88, 1], opacity: [0.85, 1, 0.85] }}
                    transition={{ duration: 3.2, repeat: Infinity, ease: 'easeInOut' }}
                    style={{ transformOrigin: '200px 200px', transformBox: 'view-box' }}
                  />
                </svg>
              ...
              <div className="p-[1px] rounded-2xl bg-[linear-gradient(135deg,rgba(114,250,147,0.55)_0%,rgba(114,250,147,0.12)_100%)]">
                <blockquote className="relative overflow-hidden rounded-[calc(1rem-1px)] bg-green/[0.08] px-5 py-4 sm:px-6 sm:py-5">
                  ...
                  <p className="text-cream/90 font-medium text-[15px] sm:text-lg leading-relaxed pl-2">
                    Non sempre basta una pastiglia.
                    <span className="text-green"> A volte serve lavorare sulla legna sul fuoco.</span>
                  </p>
                </blockquote>
              </div>
              </div>
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 sm:mt-12 text-left sm:text-center">
          <p className="text-cream/70 text-base sm:text-lg leading-relaxed mb-8 sm:mb-10">
            ...
            <strong className="font-bold text-cream">giornate</strong>, più{' '}
            <strong className="font-bold text-cream">programmi</strong> e meno rinunce
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            e iniziamo a lavorare su collo, mandibola e tensioni — la parte che finora nessuno ha
            affrontato.
          </motion.p>
