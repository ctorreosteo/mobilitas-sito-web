...
const HERO_VIDEO_CODICE = 'CICATRICI_CESAREO_VSL'
...
function useVideoCicatriciCesareoVsl() {
...
const PAIN_POINTS = [
  {
    icon: Hand,
    title: 'Zona addormentata sopra e intorno al taglio',
    body: 'Un’area di pelle che non sente il tocco o lo sente attutito, spesso ampia diversi centimetri.',
  },
  {
    icon: Link2,
    title: 'Sensazione di “tiraggio” interno',
    body: 'Allungandoti, girandoti o stirandoti senti qualcosa che tira dentro la pancia.',
  },
  {
    icon: Layers,
    title: 'Cicatrice aderente, che non scorre',
    body: 'Provi a muoverla con le dita e resta attaccata ai piani sotto, come incollata.',
  },
  {
    icon: FoldHorizontal,
    title: 'Il “gradino” o piega sopra la cicatrice',
    body: 'Una sporgenza di tessuto che si forma appena sopra il taglio, indipendente dal peso.',
  },
  {
    icon: PersonStanding,
    title: 'Dolore lombare comparso dopo il parto',
    body: 'Mal di schiena nella zona bassa senza un trauma che lo giustifichi.',
  },
  {
    icon: CircleAlert,
    title: 'Fastidio o dolore alla palpazione',
    body: 'Toccando la zona, anche anni dopo, senti dolore o un fastidio strano.',
  },
  {
    icon: Sparkles,
    title: 'Prurito, bruciore o formicolio nella zona',
    body: 'Sensazioni anomale dovute ai nervi superficiali coinvolti nel taglio.',
  },
  {
    icon: Activity,
    title: 'Difficoltà ad attivare gli addominali bassi',
    body: 'Fai gli esercizi e senti che quella zona non si accende, come se il collegamento non ci fosse.',
  },
  {
    icon: Shirt,
    title: 'Fastidio con i vestiti che premono',
    body: 'Il bottone dei jeans o la cintura proprio su quella linea danno fastidio.',
  },
  {
    icon: Heart,
    title: 'Dolore durante i rapporti o al bacino',
    body: 'Tensioni che si trasmettono in profondità, verso il bacino e il pavimento pelvico.',
  },
]
...
const MECHANISM_STEPS = [
  {
    k: '01',
    t: 'La cicatrice incolla gli strati',
    b: 'Pelle, tessuto sotto e muscolo guariscono restando aderenti tra loro: è il lavoro della cicatrice.',
  },
  {
    k: '02',
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    question: (
      <>
        Che c’entra la cicatrice col mio <strong>mal di schiena</strong>?
      </>
    ),
    answer: (
      <>
...
function CicatriciCesareo() {
  const { video: heroVideo, loading: heroVideoLoading } = useVideoCicatriciCesareoVsl()
  ...
  useEffect(() => {
    ...
    const description =
      'Osteopata per cicatrice da cesareo a Torino (San Donato e Crocetta). Lavoriamo su aderenze, scorrimento dei tessuti, pancia e postura post-parto. Prima visita 49€.'
    ...
    ensureMetaByName(
      'keywords',
      [
        'osteopata cicatrice cesareo torino',
        'cicatrice cesareo osteopata',
        'aderenze cicatrice cesareo',
        'trattamento cicatrice cesareo',
        'post parto osteopata torino',
        'cicatrice addominale osteopatia',
        'gradino cicatrice cesareo',
        'mal di schiena dopo cesareo',
        'massaggio cicatrice cesareo',
        'osteopata post parto torino',
    ...
    ensureMetaByProperty('og:image:alt', 'Trattamento osteopatico per cicatrice da cesareo – Studio Mobilitas Torino')
    ...
    ensureMetaByName('twitter:title', 'Osteopata Cicatrice Cesareo Torino | Mobilitas')
    ensureMetaByName('twitter:description', description)
    ensureMetaByName('twitter:image', ogImage)
    ensureMetaByName('twitter:image:alt', 'Trattamento osteopatico per cicatrice da cesareo – Mobilitas Torino')
    ...
    const jsonLd = {
      ...
      '@graph': [
        ...
        },
        {
          ...
          name: 'Cicatrice da taglio cesareo e aderenze',
          alternateName: [
            'Cicatrice cesareo',
            'Aderenze cicatrice addominale',
            'Cicatrice post-parto',
            'Tiraggio cicatrice cesareo',
            'Cicatrice aderente',
            'Disfunzione cicatriziale post-cesareo',
          ],
          associatedAnatomy: {
            '@type': 'AnatomicalStructure',
            name: 'Parete addominale, cicatrice cesarea e bacino',
          },
        },
        {
          '@type': 'MedicalTherapy',
          '@id': `${pageUrl}#service`,
          name: 'Trattamento osteopatico per cicatrice da cesareo',
          description:
            'Approccio osteopatico integrato su cicatrice, aderenze, tessuti addominali, bacino e postura post-parto.',
          url: pageUrl,
          ...
          offers: {
            ...
            url: pageUrl,
            name: 'Prima visita osteopatica per cicatrice da cesareo',
          },
        },
        {
          ...businessShared,
    ...
    let scriptLd = document.querySelector('script[type="application/ld+json"][data-page="cicatrici-cesareo"]')
    if (!scriptLd) {
      scriptLd = document.createElement('script')
      scriptLd.setAttribute('type', 'application/ld+json')
      scriptLd.setAttribute('data-page', 'cicatrici-cesareo')
    ...
    return () => {
      ...
      const toRemove = document.querySelector('script[type="application/ld+json"][data-page="cicatrici-cesareo"]')
              ...
              <div className="relative overflow-hidden rounded-[calc(1rem-1px)] sm:rounded-[calc(1.35rem-1px)] aspect-[16/9] bg-[#002552]">
                {heroVideo ? (
                  <>
                    ...
                    <iframe
                      src={heroVideoSrc}
                      title={heroVideo.titolo || 'Video trattamento cicatrice cesareo - Mobilitas Torino'}
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-black leading-tight max-w-2xl mb-4 sm:mb-5">
              La cicatrice non ti limita solo sul taglio.
              <br />
              <span className="text-green">Ti limita nel corpo che non risponde più.</span>
            </h2>
            <p className="text-cream/60 text-base sm:text-lg leading-relaxed max-w-xl">
              ...
              <strong className="font-bold text-cream">scorrimento</strong>,{' '}
              <strong className="font-bold text-cream">sensibilità</strong> e{' '}
              <strong className="font-bold text-cream">serenità</strong> nel tuo corpo.
            </p>
          </motion.div>
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-14 lg:mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-16 items-center">
            {/* — Emblema animato: gli strati che restano aderenti — */}
            <motion.figure
            ...
            >
              ...
              <div className="relative aspect-square">
                ...
                <svg viewBox="0 0 400 400" className="absolute inset-0 w-full h-full">
                  <defs>
                    <radialGradient id="cicatrici-cesareo-core" cx="50%" cy="50%" r="50%">
                  ...
                  <motion.g
                    ...
                    style={{ transformOrigin: '200px 200px', transformBox: 'view-box' }}
                  >
                    <rect x="88" y="118" width="224" height="36" rx="18" fill="none" stroke="#72fa93" strokeOpacity="0.22" strokeWidth="14" />
                    <rect x="88" y="118" width="224" height="36" rx="18" fill="none" stroke="#72fa93" strokeOpacity="0.85" strokeWidth="1.5" />
                    <rect x="88" y="182" width="224" height="36" rx="18" fill="none" stroke="#72fa93" strokeOpacity="0.22" strokeWidth="14" />
                    <rect x="88" y="182" width="224" height="36" rx="18" fill="none" stroke="#72fa93" strokeOpacity="0.85" strokeWidth="1.5" />
                    <rect x="88" y="246" width="224" height="36" rx="18" fill="none" stroke="#72fa93" strokeOpacity="0.22" strokeWidth="14" />
                    <rect x="88" y="246" width="224" height="36" rx="18" fill="none" stroke="#72fa93" strokeOpacity="0.85" strokeWidth="1.5" />
                  </motion.g>

                  {/* linea cicatrice verticale */}
                  <motion.line
                    x1="200" y1="110" x2="200" y2="290"
                    stroke="#72fa93"
                    strokeWidth="3"
                    strokeLinecap="round"
                  ...
                  <circle cx="200" cy="200" r="38" fill="url(#cicatrici-cesareo-core)" />
                  <motion.circle
                    cx="200" cy="200" r="24"
                ...
                <span className="absolute top-[46%] right-5 flex flex-row-reverse items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.16em] text-cream/50">
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 sm:mt-12 text-left sm:text-center">
          <p className="text-cream/70 text-base sm:text-lg leading-relaxed mb-8 sm:mb-10">
            ...
            <strong className="font-bold text-cream">scorrimento</strong>, meno{' '}
            <strong className="font-bold text-cream">tiraggio</strong> e un corpo che torna a
            risponderti. Inizia con un consulto telefonico o la prima visita.
          </p>
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:block relative mx-auto max-w-4xl h-[48rem]">
            ...
            >
              <defs>
                <linearGradient id="visitWaveCicatriciCesareo" x1="0" y1="0" x2="0" y2="1">
                ...
                <filter id="visitGlowCicatriciCesareo" x="-50%" y="-8%" width="200%" height="116%">
              ...
              <path
                ...
                strokeOpacity="0.14"
                strokeLinecap="round"
                filter="url(#visitGlowCicatriciCesareo)"
              />
              <path
                d="M260 48
                   C 260 95, 540 115, 540 160
                   ...
                   C 260 543, 540 563, 540 608
                   C 540 653, 260 673, 260 720"
                stroke="url(#visitWaveCicatriciCesareo)"
                strokeWidth="2.5"
                strokeLinecap="round"
              />
              <path
          ...
          <div className="lg:hidden relative">
            ...
            >
              <defs>
                <linearGradient id="visitWaveMobileCicatriciCesareo" x1="0" y1="0" x2="0" y2="1">
              ...
              <path
                d="M40 10
                   ...
                   C 62 610, 18 670, 40 730
                   C 62 790, 18 850, 40 890"
                stroke="url(#visitWaveMobileCicatriciCesareo)"
                strokeWidth="2.25"
                strokeLinecap="round"
              />
              <path
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            e iniziamo a costruire un percorso concreto per scollare gli strati — oltre a creme e
            tempo.
          </motion.p>
...
export default CicatriciCesareo
