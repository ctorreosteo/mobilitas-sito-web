...
const HERO_VIDEO_CODICE = 'FIBROMIALGIA_VSL'
...
function useVideoFibromialgiaVsl() {
...
const PAIN_POINTS = [
  {
    icon: Zap,
    title: 'Dolore diffuso in tutto il corpo',
    body: 'Un dolore muscolare presente su entrambi i lati, sopra e sotto la vita, da almeno tre mesi. È il criterio principale.',
  },
  {
    icon: MapPin,
    title: 'Punti dolorosi alla pressione',
    body: 'Zone specifiche (collo, spalle, torace, gomiti, anche, ginocchia) che fanno male anche con una pressione leggera.',
  },
  {
    icon: BatteryLow,
    title: 'Stanchezza profonda e costante',
    body: 'Una spossatezza che il riposo non risolve e che non è proporzionata a quello che hai fatto.',
  },
  {
    icon: Moon,
    title: 'Sonno non ristoratore',
    body: 'Dormi ma ti svegli come se non avessi dormito, spesso con il corpo rigido e dolorante.',
  },
  {
    icon: CloudFog,
    title: '“Fibro fog” — nebbia cognitiva',
    body: 'Difficoltà di concentrazione, memoria a corto raggio, parole che non ti vengono.',
  },
  {
    icon: AlarmClock,
    title: 'Rigidità mattutina prolungata',
    body: 'Il corpo è duro al risveglio e ci vuole tempo prima di sbloccarsi.',
  },
  {
    icon: CircleAlert,
    title: 'Mal di testa frequenti',
    body: 'Cefalee tensive o emicranie che si aggiungono a tutto il resto.',
  },
  {
    icon: Volume2,
    title: 'Sensibilità aumentata agli stimoli',
    body: 'Rumori, luci, freddo, odori: cose che gli altri sopportano tranquillamente per te diventano fastidiose o dolorose.',
  },
  {
    icon: Activity,
    title: 'Disturbi intestinali',
    body: 'Colon irritabile, gonfiore, alternanza di stitichezza e diarrea — molto frequenti in associazione.',
  },
  {
    icon: RefreshCw,
    title: 'Sintomi che vanno e vengono',
    body: 'Periodi migliori e riacutizzazioni, spesso legate a stress, freddo, sforzi o cambi di stagione.',
  },
]
...
const MECHANISM_STEPS = [
  ...
  {
    k: '02',
    t: 'Le tensioni alimentano l’amplificatore',
    b: 'Un corpo pieno di tensioni manda continuamente segnali dentro quell’impianto: più ingressi, più rumore.',
  },
  {
    k: '03',
    t: 'Ridurre le tensioni toglie legna al fuoco',
    b: 'Non è la guarigione: è ridurre ciò che entra nell’amplificatore, un pezzo alla volta.',
  },
]
...
function Fibromialgia() {
  const { video: heroVideo, loading: heroVideoLoading } = useVideoFibromialgiaVsl()
  ...
  useEffect(() => {
    ...
    const description =
      'Osteopata per fibromialgia a Torino (San Donato e Crocetta). Lavoriamo su tensioni, sonno e respiro con tecniche dolci calibrate, in affiancamento al percorso reumatologico. Prima visita 49€.'
    ...
    ensureMetaByName(
      'keywords',
      [
        'osteopata fibromialgia torino',
        'fibromialgia torino',
        'osteopatia fibromialgia',
        'trattamento fibromialgia osteopata',
        'dolore diffuso osteopata',
        'fibro fog osteopatia',
        'sonno non ristoratore fibromialgia',
        'tensioni muscolari fibromialgia',
        'fibromialgia tecniche dolci',
        'osteopata reumatologo torino',
    ...
    ensureMetaByProperty('og:image:alt', 'Trattamento osteopatico per fibromialgia – Studio Mobilitas Torino')
    ...
    ensureMetaByName('twitter:title', 'Osteopata Fibromialgia Torino | Mobilitas')
    ensureMetaByName('twitter:description', description)
    ensureMetaByName('twitter:image', ogImage)
    ensureMetaByName('twitter:image:alt', 'Trattamento osteopatico per fibromialgia – Mobilitas Torino')
      ...
      '@graph': [
        ...
        },
        {
          ...
          alternateName: [
            ...
            'Fibromyalgia',
            'Dolore nociplastico',
            'Stanchezza cronica con dolore',
            'Fibro fog',
          ],
          associatedAnatomy: {
            '@type': 'AnatomicalStructure',
            name: 'Sistema muscoloscheletrico e sistema nervoso centrale',
          },
        },
        {
          '@type': 'MedicalTherapy',
          '@id': `${pageUrl}#service`,
          name: 'Trattamento osteopatico per fibromialgia',
          description:
            'Approccio osteopatico dolce e graduato su tensioni, diaframma, respiro e qualità del sonno, in affiancamento al percorso reumatologico e neurologico.',
          url: pageUrl,
          ...
          offers: {
            ...
            url: pageUrl,
            name: 'Prima visita osteopatica per fibromialgia',
          },
        },
        {
          ...businessShared,
    ...
    let scriptLd = document.querySelector('script[type="application/ld+json"][data-page="fibromialgia"]')
    if (!scriptLd) {
      scriptLd = document.createElement('script')
      scriptLd.setAttribute('type', 'application/ld+json')
      scriptLd.setAttribute('data-page', 'fibromialgia')
    ...
    return () => {
      ...
      const toRemove = document.querySelector('script[type="application/ld+json"][data-page="fibromialgia"]')
              ...
              <div className="relative overflow-hidden rounded-[calc(1rem-1px)] sm:rounded-[calc(1.35rem-1px)] aspect-[16/9] bg-[#002552]">
                {heroVideo ? (
                  <>
                    ...
                    <iframe
                      src={heroVideoSrc}
                      title={heroVideo.titolo || 'Video trattamento fibromialgia - Mobilitas Torino'}
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          ...
          >
            ...
            <p className="text-cream/60 text-base sm:text-lg leading-relaxed max-w-xl">
              ...
              <strong className="font-bold text-cream">relazioni</strong> e{' '}
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-14 lg:mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-16 items-center">
            {/* — Emblema animato: il volume del dolore alzato — */}
            <motion.figure
            ...
            >
              ...
              <div className="relative aspect-square">
                ...
                <svg viewBox="0 0 400 400" className="absolute inset-0 w-full h-full">
                  <defs>
                    <radialGradient id="fibromialgia-core" cx="50%" cy="50%" r="50%">
                  ...
                  {/* onde di amplificazione */}
                  <motion.g
                    animate={{ scale: [1, 1.06, 1], opacity: [0.55, 1, 0.55] }}
                    transition={{ duration: 3.6, repeat: Infinity, ease: 'easeInOut' }}
                    style={{ transformOrigin: '200px 200px', transformBox: 'view-box' }}
                  >
                    <circle cx="200" cy="200" r="58" fill="none" stroke="#72fa93" strokeOpacity="0.25" strokeWidth="12" />
                    <circle cx="200" cy="200" r="88" fill="none" stroke="#72fa93" strokeOpacity="0.18" strokeWidth="10" />
                    <circle cx="200" cy="200" r="118" fill="none" stroke="#72fa93" strokeOpacity="0.12" strokeWidth="8" />
                    <circle cx="200" cy="200" r="58" fill="none" stroke="#72fa93" strokeOpacity="0.85" strokeWidth="1.5" />
                    <circle cx="200" cy="200" r="88" fill="none" stroke="#72fa93" strokeOpacity="0.55" strokeWidth="1.25" />
                    <circle cx="200" cy="200" r="118" fill="none" stroke="#72fa93" strokeOpacity="0.35" strokeWidth="1" />
                  </motion.g>

                  <circle cx="200" cy="200" r="36" fill="url(#fibromialgia-core)" />
                  <motion.circle
                    cx="200" cy="200" r="22"
                ...
                <span className="absolute top-[46%] right-5 flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.16em] text-cream/70">
                  <span className="w-1.5 h-1.5 rounded-full bg-cream/60" />
                  Sonno
                </span>
              ...
              <figcaption className="px-4 py-3.5 sm:px-5 sm:py-4 text-center text-cream/55 text-sm leading-snug text-balance border-t border-cream/10">
                Il volume resta alto. Si può ridurre ciò che entra nell’amplificatore.
              </figcaption>
              </div>
              </div>
            </motion.figure>
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:block relative mx-auto max-w-4xl h-[48rem]">
            ...
            >
              <defs>
                <linearGradient id="visitWaveFibromialgia" x1="0" y1="0" x2="0" y2="1">
                ...
                <filter id="visitGlowFibromialgia" x="-50%" y="-8%" width="200%" height="116%">
              ...
              <path
                ...
                strokeOpacity="0.14"
                strokeLinecap="round"
                filter="url(#visitGlowFibromialgia)"
              />
              <path
                d="M260 48
                   C 260 95, 540 115, 540 160
                   ...
                   C 260 543, 540 563, 540 608
                   C 540 653, 260 673, 260 720"
                stroke="url(#visitWaveFibromialgia)"
                strokeWidth="2.5"
                strokeLinecap="round"
              />
              <path
          ...
          <div className="lg:hidden relative">
            ...
            >
              <defs>
                <linearGradient id="visitWaveMobileFibromialgia" x1="0" y1="0" x2="0" y2="1">
              ...
              <path
                d="M40 10
                   ...
                   C 62 610, 18 670, 40 730
                   C 62 790, 18 850, 40 890"
                stroke="url(#visitWaveMobileFibromialgia)"
                strokeWidth="2.25"
                strokeLinecap="round"
              />
              <path
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            e iniziamo a costruire un percorso concreto sulle tensioni — oltre a “è nella tua
            testa”.
          </motion.p>
