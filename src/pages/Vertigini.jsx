...
const HERO_VIDEO_CODICE = 'VERTIGINI_VSL'
...
const HERO_BENEFITS = [
  <>
    Smetti di vivere in <strong className="font-bold">allerta</strong>, aspettando il prossimo{' '}
...
const PAIN_POINTS = [
  {
    icon: RotateCcw,
    title: 'La stanza che gira appena ti giri nel letto',
    body: 'Ti volti sul fianco, guardi in alto per prendere qualcosa dallo scaffale, e il mondo parte in rotazione. Bastano pochi secondi, ma sono terrificanti.',
  },
  {
    icon: Footprints,
    title: 'La sensazione di camminare sulla gommapiuma',
    body: 'Non è che gira: è che il terreno non è stabile. Cammini come su un materasso, come sul ponte di una nave. Instabilità costante, sorda, che non passa mai del tutto.',
  },
  {
    icon: CloudFog,
    title: 'La testa “ovattata” / annebbiata',
    body: 'Quella sensazione di avere la testa piena di cotone, di essere dentro una bolla, staccato dal mondo. Non è dolore, non è vertigine vera: è un non-esserci che nessuno riesce a descrivere bene al medico.',
  },
  {
    icon: Zap,
    title: 'Il senso di sbandamento improvviso',
    body: 'Cammini normale e per un attimo ti tira da un lato, come se qualcuno ti spingesse. Un secondo, poi passa. Ma quel secondo ti resta addosso tutto il giorno.',
  },
  {
    icon: Droplets,
    title: 'La nausea con sudore freddo',
    body: 'Lo stomaco che si rivolta, la salivazione che aumenta, il sudore gelido, il pallore. Il corpo intero che collassa insieme alla testa.',
  },
  {
    icon: Eye,
    title: 'La visione che si muove / gli oggetti che ballano',
    body: 'Guardi un punto fermo e sembra oscillare. Leggi e le righe si spostano. Lo scaffale del supermercato che “vibra”.',
  },
  {
    icon: CircleDot,
    title: 'La testa pesante e il collo rigido',
    body: 'Sensazione di casco, tensione alla base del cranio, collo bloccato. E ti chiedi se sia la cervicale a farti girare la testa o il contrario.',
  },
  {
    icon: Ear,
    title: 'Il fischio o l’orecchio “pieno”',
    body: 'Ronzio, orecchio ovattato, senso di pressione o tappo. Il sospetto che orecchio e vertigine c’entrino qualcosa tra loro.',
  },
  {
    icon: ArrowUpFromLine,
    title: 'Il “vuoto alla testa” quando ti alzi',
    body: 'Ti alzi dalla sedia o dal letto e per qualche secondo tutto si annebbia, devi appoggiarti. Ogni cambio di posizione è un piccolo azzardo.',
  },
  {
    icon: Monitor,
    title: 'La vista che si affatica / gli occhi che non tengono',
    body: 'Fissare lo schermo, guidare al tramonto, i luoghi affollati e pieni di stimoli visivi ti scatenano il malessere. Il supermercato è il posto peggiore del mondo.',
  },
]
...
const MECHANISM_STEPS = [
  {
    k: '01',
    t: 'Tre sistemi devono parlarsi',
    b: 'L’equilibrio nasce da orecchie, occhi e segnali del collo: se uno dei tre manda informazioni confuse, il cervello perde stabilità.',
  },
  {
    k: '02',
    t: 'Il collo e la mandibola confondono i segnali',
    b: 'Quando il collo è rigido, la mandibola resta serrata o la postura è sbilanciata, i messaggi sullo spazio arrivano distorti.',
  },
  {
    k: '03',
    t: 'Nasce l’instabilità che senti',
    b: 'Se le informazioni non tornano tra loro, il risultato può essere proprio quella sensazione di sbandamento, bolla o pavimento che manca.',
  },
]
...
const AFTER_IMAGES_BENEFITS = [
  <>
    Sciogliamo le <strong className="font-bold">tensioni di collo e mandibola</strong> che
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: (
      <>
        La paura c’è, ed è comprensibile: ma spesso è la <em>conseguenza</em> degli attacchi, non
        la causa. Meritano entrambe una risposta, senza liquidarti con un’etichetta vaga.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        È la prima cosa da capire, ed è lo scopo della chiamata e della prima visita: se non lo è,
        te lo diciamo. Nessuna promessa facile, solo chiarezza.
      </>
    ),
  },
  {
...
function Vertigini() {
  const { video: heroVideo, loading: heroVideoLoading } = useVideoVertiginiVsl()
  ...
  useEffect(() => {
    ...
    const description =
      'Osteopata per vertigini e instabilità a Torino (San Donato e Crocetta). Lavoriamo su collo, mandibola e postura, in affiancamento al percorso ORL e neurologico. Prima visita 49€.'
    ...
    ensureMetaByName(
      'keywords',
      [
        'osteopata vertigini torino',
        'vertigini torino',
        'osteopatia vertigini',
        'trattamento vertigini osteopata',
        'instabilità equilibrio osteopata',
        'vertigini cervicali torino',
        'capogiri osteopata torino',
        'vertigine postura collo',
        'osteopata orecchio a posto',
        'riabilitazione equilibrio torino',
    ...
    ensureMetaByProperty('og:image:alt', 'Trattamento osteopatico per vertigini e instabilità – Studio Mobilitas Torino')
    ...
    ensureMetaByName('twitter:title', 'Osteopata Vertigini Torino | Mobilitas')
    ensureMetaByName('twitter:description', description)
    ensureMetaByName('twitter:image', ogImage)
    ensureMetaByName('twitter:image:alt', 'Trattamento osteopatico per vertigini – Mobilitas Torino')
    ...
    const jsonLd = {
      ...
      '@graph': [
        ...
        },
        {
          ...
          name: 'Vertigini e instabilità dell’equilibrio',
          alternateName: [
            'Vertigine',
            'Capogiri',
          ...
          associatedAnatomy: {
            ...
            name: 'Collo, sistema vestibolare e postura',
          },
        },
        {
          '@type': 'MedicalTherapy',
          '@id': `${pageUrl}#service`,
          name: 'Trattamento osteopatico per vertigini e instabilità',
          description:
            'Approccio osteopatico integrato su collo, mandibola, base del cranio e postura, in affiancamento al percorso ORL e neurologico.',
          url: pageUrl,
          ...
          offers: {
            ...
            url: pageUrl,
            name: 'Prima visita osteopatica per vertigini',
          },
        },
        {
          ...businessShared,
        ...
        },
        {
          ...
          mainEntity: [
            ...
            {
              '@type': 'Question',
              name: 'Il mio caso è trattabile?',
              acceptedAnswer: {
                '@type': 'Answer',
                text: 'È la prima cosa da capire, ed è lo scopo della chiamata e della prima visita: se non lo è, te lo diciamo. Nessuna promessa facile, solo chiarezza.',
              },
            },
            {
              '@type': 'Question',
    ...
    let scriptLd = document.querySelector('script[type="application/ld+json"][data-page="vertigini"]')
    if (!scriptLd) {
      scriptLd = document.createElement('script')
      scriptLd.setAttribute('type', 'application/ld+json')
      scriptLd.setAttribute('data-page', 'vertigini')
    ...
    return () => {
      ...
      const toRemove = document.querySelector('script[type="application/ld+json"][data-page="vertigini"]')
      ...
      <section className="relative z-[2] pt-14 pb-16 sm:pt-20 sm:pb-24 lg:pt-28 lg:pb-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 text-left sm:text-center">
          ...
          >
            ...
            <strong className="font-bold text-cream">postura</strong> per rimettere ordine nei
            segnali dell’equilibrio e ridurre la paura del prossimo attacco.
          </motion.p>
              ...
              <div className="relative overflow-hidden rounded-[calc(1rem-1px)] sm:rounded-[calc(1.35rem-1px)] aspect-[16/9] bg-[#002552]">
                {heroVideo ? (
                  <>
                    ...
                    <iframe
                      src={heroVideoSrc}
                      title={heroVideo.titolo || 'Video trattamento vertigini - Mobilitas Torino'}
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-black leading-tight max-w-2xl mb-4 sm:mb-5">
              La vertigine non ti limita solo nei sintomi.
              <br />
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-14 lg:mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-16 items-center">
            {/* — Emblema animato: il triangolo dell’equilibrio — */}
            <motion.figure
            ...
            >
              ...
              <div className="relative aspect-square">
                ...
                <svg viewBox="0 0 400 400" className="absolute inset-0 w-full h-full">
                  <defs>
                    <radialGradient id="vertigini-core" cx="50%" cy="50%" r="50%">
                  ...
                  {/* nodi: orecchie / occhi / collo */}
                  <circle cx="200" cy="78" r="14" fill="#002552" stroke="#72fa93" strokeWidth="2" />
                  <circle cx="312" cy="288" r="14" fill="#002552" stroke="#72fa93" strokeWidth="2" />
                  <circle cx="88" cy="288" r="14" fill="#002552" stroke="#72fa93" strokeWidth="2" />

                  {/* centro: cervello / accordo */}
                  <circle cx="200" cy="210" r="42" fill="url(#vertigini-core)" />
                  <motion.circle
                    cx="200" cy="210" r="28"
                    fill="none" stroke="#72fa93" strokeWidth="2.5"
                    animate={{ scale: [1, 0.92, 1], opacity: [0.85, 1, 0.85] }}
                    transition={{ duration: 4.5, repeat: Infinity, ease: 'easeInOut' }}
                    style={{ transformOrigin: '200px 210px', transformBox: 'view-box' }}
                  />
                </svg>
              ...
              <figcaption className="px-4 py-3.5 sm:px-5 sm:py-4 text-center text-cream/55 text-sm leading-snug text-balance border-t border-cream/10">
                In equilibrio, orecchie, occhi e collo devono parlarsi tra loro.
              </figcaption>
              </div>
              </div>
            </motion.figure>
            ...
            >
              ...
              <p className="text-cream/75 text-[15px] sm:text-lg leading-relaxed mb-6 lg:mb-7">
                L’equilibrio non dipende solo dall’orecchio. Il tuo corpo capisce dove si trova
                nello spazio grazie a tre cose che devono parlarsi tra loro: le{' '}
                <strong className="text-cream font-semibold">orecchie</strong>, gli{' '}
                <strong className="text-cream font-semibold">occhi</strong> e i segnali che arrivano
                dal <strong className="text-cream font-semibold">collo</strong>. Quando quei
                segnali arrivano confusi, può nascere proprio l’instabilità che senti.
              </p>
              ...
              <div className="p-[1px] rounded-2xl bg-[linear-gradient(135deg,rgba(114,250,147,0.55)_0%,rgba(114,250,147,0.12)_100%)]">
                <blockquote className="relative overflow-hidden rounded-[calc(1rem-1px)] bg-green/[0.08] px-5 py-4 sm:px-6 sm:py-5">
                  ...
                  <p className="text-cream/90 font-medium text-[15px] sm:text-lg leading-relaxed pl-2">
                    Non sempre serve un altro esame.
                    <span className="text-green"> A volte serve rimettere ordine nei segnali del collo.</span>
                  </p>
                </blockquote>
              </div>
              </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 lg:pt-8">
          ...
          >
            ...
            <p className="text-cream/60 text-base sm:text-lg leading-relaxed max-w-xl">
              ...
              <strong className="font-bold text-cream">impatto</strong> della vertigine sulla tua
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 sm:mt-12 text-left sm:text-center">
          <p className="text-cream/70 text-base sm:text-lg leading-relaxed mb-8 sm:mb-10">
            ...
            <strong className="font-bold text-cream">autonomia</strong>, più{' '}
            <strong className="font-bold text-cream">sicurezza nel movimento</strong> e meno paura
            del prossimo attacco. Inizia con un consulto telefonico o la prima visita.
          </p>
