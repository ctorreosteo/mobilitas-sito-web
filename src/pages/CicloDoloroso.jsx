...
const HERO_VIDEO_CODICE = 'CICLO_DOLOROSO_VSL'
...
function useVideoCicloDolorosoVsl() {
...
const PAIN_POINTS = [
  {
    icon: Zap,
    title: 'Crampi al basso ventre',
    body: 'Dolore pulsante o a fitte nella parte bassa della pancia, che inizia poco prima o con l’arrivo del ciclo.',
  },
  {
    icon: PersonStanding,
    title: 'Dolore alla schiena bassa',
    body: 'Un dolore sordo nella zona lombare e sacrale, che spesso accompagna i crampi.',
  },
  {
    icon: MoveDown,
    title: 'Dolore che scende alle cosce',
    body: 'Le gambe diventano pesanti e il dolore si irradia verso l’interno coscia.',
  },
  {
    icon: Frown,
    title: 'Nausea e a volte vomito',
    body: 'Nei giorni peggiori lo stomaco si chiude e mangiare diventa difficile.',
  },
  {
    icon: CircleAlert,
    title: 'Mal di testa',
    body: 'Cefalea che compare nei giorni del ciclo o poco prima.',
  },
  {
    icon: BatteryLow,
    title: 'Stanchezza intensa',
    body: 'Una spossatezza sproporzionata, che ti costringe a rallentare tutto.',
  },
  {
    icon: Activity,
    title: 'Disturbi intestinali',
    body: 'Diarrea, gonfiore o crampi intestinali che si sommano a quelli mestruali.',
  },
  {
    icon: Bed,
    title: 'Dolore che ti costringe a fermarti',
    body: 'Non riesci a lavorare, uscire o studiare: devi sdraiarti e aspettare.',
  },
  {
    icon: CalendarDays,
    title: 'Il dolore inizia prima del ciclo',
    body: 'Uno o due giorni prima senti già la pancia tirare e la schiena pesante.',
  },
  {
    icon: TrendingDown,
    title: 'Peggiora nei primi due giorni e poi si attenua',
    body: 'Il picco è all’inizio del flusso, poi tende a ridursi.',
  },
]
...
const MECHANISM_STEPS = [
  ...
  {
    k: '02',
    t: 'Se il bacino è rigido, le contrazioni trovano resistenza',
    b: 'Schiena bassa che tira e tessuti che scorrono male: le stesse contrazioni fanno più male.',
  },
  {
    k: '03',
...
function CicloDoloroso() {
  const { video: heroVideo, loading: heroVideoLoading } = useVideoCicloDolorosoVsl()
  ...
  useEffect(() => {
    ...
    const description =
      'Osteopata per ciclo doloroso e dismenorrea a Torino (San Donato e Crocetta). Lavoriamo su bacino, diaframma e zona lombare, in affiancamento al percorso ginecologico. Prima visita 49€.'
    ...
    ensureMetaByName(
      'keywords',
      [
        'osteopata ciclo doloroso torino',
        'dismenorrea osteopata',
        'ciclo mestruale doloroso torino',
        'crampi mestruali osteopatia',
        'mal di schiena ciclo osteopata',
        'bacino e ciclo doloroso',
        'endometriosi osteopata torino',
        'dolore mestruale trattamento',
        'osteopata ginecologico torino',
        'dismenorrea primaria torino',
    ...
    ensureMetaByProperty('og:image:alt', 'Trattamento osteopatico per ciclo doloroso – Studio Mobilitas Torino')
    ...
    ensureMetaByName('twitter:title', 'Osteopata Ciclo Doloroso Torino | Mobilitas')
    ensureMetaByName('twitter:description', description)
    ensureMetaByName('twitter:image', ogImage)
    ensureMetaByName('twitter:image:alt', 'Trattamento osteopatico per ciclo doloroso – Mobilitas Torino')
    ...
    const jsonLd = {
      ...
      '@graph': [
        ...
        },
        {
          ...
          name: 'Ciclo doloroso e dismenorrea',
          alternateName: [
            'Ciclo doloroso',
            'Dismenorrea',
            'Crampi mestruali',
          ...
          associatedAnatomy: {
            ...
            name: 'Bacino, utero, diaframma e zona lombare',
          },
        },
        {
          '@type': 'MedicalTherapy',
          '@id': `${pageUrl}#service`,
          name: 'Trattamento osteopatico per ciclo doloroso',
          description:
            'Approccio osteopatico integrato su bacino, osso sacro, zona lombare, diaframma e pancia bassa, in affiancamento al percorso ginecologico.',
          url: pageUrl,
          ...
          offers: {
            ...
            url: pageUrl,
            name: 'Prima visita osteopatica per ciclo doloroso',
          },
        },
        {
          ...businessShared,
    ...
    let scriptLd = document.querySelector('script[type="application/ld+json"][data-page="ciclo-doloroso"]')
    if (!scriptLd) {
      scriptLd = document.createElement('script')
      scriptLd.setAttribute('type', 'application/ld+json')
      scriptLd.setAttribute('data-page', 'ciclo-doloroso')
    ...
    return () => {
      ...
      const toRemove = document.querySelector('script[type="application/ld+json"][data-page="ciclo-doloroso"]')
              ...
              <div className="relative overflow-hidden rounded-[calc(1rem-1px)] sm:rounded-[calc(1.35rem-1px)] aspect-[16/9] bg-[#002552]">
                {heroVideo ? (
                  <>
                    ...
                    <iframe
                      src={heroVideoSrc}
                      title={heroVideo.titolo || 'Video trattamento ciclo doloroso - Mobilitas Torino'}
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-black leading-tight max-w-2xl mb-4 sm:mb-5">
              Il ciclo doloroso non ti limita solo nei crampi.
              <br />
              <span className="text-green">Ti toglie giorni interi dalla vita.</span>
            </h2>
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-14 lg:mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-16 items-center">
            {/* — Emblema animato: il bacino che ospita l’utero — */}
            <motion.figure
            ...
            >
              ...
              <div className="relative aspect-square">
                ...
                <svg viewBox="0 0 400 400" className="absolute inset-0 w-full h-full">
                  <defs>
                    <radialGradient id="ciclo-doloroso-core" cx="50%" cy="50%" r="50%">
                  ...
                  >
                    <path
                      d="M118 150 Q200 118 282 150 L268 268 Q200 298 132 268 Z"
                      fill="none"
                      stroke="#72fa93"
                      strokeOpacity="0.22"
                      strokeWidth="16"
                  ...
                  <motion.ellipse
                    ...
                    stroke="#72fa93"
                    strokeWidth="2"
                    animate={{ scale: [1, 0.86, 1], opacity: [0.5, 1, 0.5] }}
                    transition={{ duration: 2.8, repeat: Infinity, ease: 'easeInOut' }}
                    style={{ transformOrigin: '200px 210px', transformBox: 'view-box' }}
                  />

                  <circle cx="200" cy="210" r="36" fill="url(#ciclo-doloroso-core)" />
                  <motion.circle
                    cx="200" cy="210" r="22"
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 sm:mt-12 text-left sm:text-center">
          <p className="text-cream/70 text-base sm:text-lg leading-relaxed mb-8 sm:mb-10">
            ...
            <strong className="font-bold text-cream">giorni</strong>, meno{' '}
            <strong className="font-bold text-cream">crampi</strong> e un calendario che non
            decide al posto tuo. Inizia con un consulto telefonico o la prima visita.
          </p>
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:block relative mx-auto max-w-4xl h-[48rem]">
            ...
            >
              <defs>
                <linearGradient id="visitWaveCicloDoloroso" x1="0" y1="0" x2="0" y2="1">
                ...
                <filter id="visitGlowCicloDoloroso" x="-50%" y="-8%" width="200%" height="116%">
              ...
              <path
                ...
                strokeOpacity="0.14"
                strokeLinecap="round"
                filter="url(#visitGlowCicloDoloroso)"
              />
              <path
                d="M260 48
                   C 260 95, 540 115, 540 160
                   ...
                   C 260 543, 540 563, 540 608
                   C 540 653, 260 673, 260 720"
                stroke="url(#visitWaveCicloDoloroso)"
                strokeWidth="2.5"
                strokeLinecap="round"
              />
              <path
          ...
          <div className="lg:hidden relative">
            ...
            >
              <defs>
                <linearGradient id="visitWaveMobileCicloDoloroso" x1="0" y1="0" x2="0" y2="1">
              ...
              <path
                d="M40 10
                   ...
                   C 62 610, 18 670, 40 730
                   C 62 790, 18 850, 40 890"
                stroke="url(#visitWaveMobileCicloDoloroso)"
                strokeWidth="2.25"
                strokeLinecap="round"
              />
              <path
      ...
      <section className="relative z-[2] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            e iniziamo a costruire un percorso concreto sul bacino — oltre a borsa calda e
            “è normale”.
          </motion.p>
